...
**/
return_status
spdm_authentication_totp(IN void *context, OUT uint8 *slot_mask,
...
**/
return_status do_authentication_via_spdm_totp(void* spdm_context)
{
	...
	status = spdm_authentication_totp(spdm_context, &slot_mask,
